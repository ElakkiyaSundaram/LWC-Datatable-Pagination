...
import getTotalAccountsCount from '@salesforce/apex/PaginationController.getTotalAccountsCount';
const COLUMNS = [
...
export default class DatatableServersidePagination extends LightningElement {
